...
const PlayersList: React.FC<LobbyUserProps> = ({ lobby }) => { 
    return (
        <div style={{ flexGrow: 1, margin: '0px 16px 8px 16px' }}>
            <h1>Players</h1>
...
const Play: NextPage = () => {
    ...
    return (
        <div style={{ display: 'flex', flexDirection: 'row', height: '100vh', alignItems: 'center', justifyContent: 'center' }}>
            <div style={{ display: 'flex', flexDirection: 'column', backgroundColor: 'white', height: '80%', width: '50%'}}>
                <PlayersList lobby={lobby} />
                <div style={{alignItems: 'center', justifyContent: 'center', display: 'flex', padding: '24px'}}>
